...
public final class ModBlocks {
    public static final Block ORE_NODE = new OreNodeBlock(BlockBehaviour.Properties.of().strength(-1.0F, 3_600_000.0F).sound(net.minecraft.world.level.block.SoundType.STONE).noOcclusion());
